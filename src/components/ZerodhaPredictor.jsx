        ...
        <div className="space-y-6 mt-12 mb-8">
            <div className="bg-cf-surface-high rounded p-6 relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                    ...
                    <div className="flex items-center gap-2 bg-cf-primary/10 text-cf-primary px-3 py-1 rounded text-[10px] font-semibold uppercase tracking-wider">
                        <div className="pulse-live" style={{ backgroundColor: '#ff9800' }}></div>
                        Model Active
                    </div>
                ...
                <div className="flex justify-start">
                    <button
                        ...
                        className="bg-gradient-to-r from-[#ff9800] to-[#ff5722] text-cf-bg font-bold px-6 py-3 rounded transition-all flex items-center gap-2 disabled:opacity-50 shadow-glow-primary hover:shadow-[0_0_24px_rgba(255,152,0,0.35)] text-sm"
                    >
                        ...
                        {loading && selectedStock ? (
                            ...
                            <>
                                <Target size={16} /> Compute Price Vector
                            </>
