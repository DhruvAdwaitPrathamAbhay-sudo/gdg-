...
const ExpenseForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-cf-surface-high p-4 sm:p-6 rounded-xl sm:rounded-2xl">
            <h3 className="font-display text-base sm:text-lg font-bold mb-4 sm:mb-5 text-cf-on-surface">Add New Expense</h3>
